...
class UpgradeAgent implements CodingAgent
{
    ...
    public function instructions(): string
    {
        ...
        1. **Audit.** In worktree mode the isolated checkout starts WITHOUT vendor/ — run RunComposer `install` first to establish the baseline (scripts are suppressed; that is fine). Then establish the current state: `show <package>` for the installed version, `outdated --direct` for surrounding context. Identify the target major version.
